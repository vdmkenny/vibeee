...
const USAGES = [_]struct { u8, KeyCode }{
    ...
    .{ 0x1C, .y },             .{ 0x1D, .z },           .{ 0x1E, .n1 },          .{ 0x1F, .n2 },
    .{ 0x20, .n3 },            .{ 0x21, .n4 },          .{ 0x22, .n5 },          .{ 0x23, .n6 },
    .{ 0x24, .n7 },            .{ 0x25, .n8 },          .{ 0x26, .n9 },          .{ 0x27, .n0 },
    ...
    // devices report here and some at 0x64.
      .{ 0x32, .backslash },   .{ 0x33, .semicolon },
    .{ 0x34, .apostrophe },    .{ 0x35, .grave },       .{ 0x36, .comma },       .{ 0x37, .period },
    .{ 0x38, .slash },         .{ 0x39, .caps_lock },   .{ 0x3A, .f1 },          .{ 0x3B, .f2 },
    .{ 0x3C, .f3 },            .{ 0x3D, .f4 },          .{ 0x3E, .f5 },          .{ 0x3F, .f6 },
    .{ 0x40, .f7 },            .{ 0x41, .f8 },          .{ 0x42, .f9 },          .{ 0x43, .f10 },
    .{ 0x44, .f11 },           .{ 0x45, .f12 },         .{ 0x47, .scroll_lock }, .{ 0x49, .insert },
    .{ 0x4A, .home },          .{ 0x4B, .page_up },     .{ 0x4C, .delete },      .{ 0x4D, .end },
    .{ 0x4E, .page_down },     .{ 0x4F, .right },       .{ 0x50, .left },        .{ 0x51, .down },
    .{ 0x52, .up },            .{ 0x53, .num_lock },    .{ 0x54, .kp_slash },    .{ 0x55, .keypad_asterisk },
    .{ 0x56, .kp_minus },      .{ 0x57, .kp_plus },     .{ 0x58, .kp_enter },    .{ 0x59, .kp1 },
    .{ 0x5A, .kp2 },           .{ 0x5B, .kp3 },         .{ 0x5C, .kp4 },         .{ 0x5D, .kp5 },
    .{ 0x5E, .kp6 },           .{ 0x5F, .kp7 },         .{ 0x60, .kp8 },         .{ 0x61, .kp9 },
    .{ 0x62, .kp0 },           .{ 0x63, .kp_period },

    // The extra key beside the left shift, which AZERTY needs.
      .{ 0x64, .iso_extra },   .{ 0x65, .menu },

    .{ 0xE0, .control_left },  .{ 0xE1, .shift_left },  .{ 0xE2, .alt_left },    .{ 0xE3, .super_left },
    .{ 0xE4, .control_right }, .{ 0xE5, .shift_right }, .{ 0xE6, .alt_right },   .{ 0xE7, .super_right },
};
