...
05-input raw-keycode-only agreement + hotkey KEY_* mapping; pty/line-discipline owner for eterm
(propose: minimal kernel pty pair, else eterm-side cooked-mode shim in libc termios); platformd
